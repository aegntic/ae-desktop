...
const map = {
  [Operator.RemoteComputer]: {
    text: 'If you need to use it for a long-term and stable period, you can log in to the Volcano Engine FaaS to experience the Online Computer Use Aegnt.',
    url: 'https://console.volcengine.com/vefaas/region:vefaas+cn-beijing/market/computer/?channel=github&source=UI-AE',
  },
  [Operator.RemoteBrowser]: {
    text: 'If you need to use it for a long-term and stable period, you can log in to the Volcano Engine FaaS to experience the Online Browser Use Aegnt.',
    url: 'https://console.volcengine.com/vefaas/region:vefaas+cn-beijing/market/browser/?channel=github&source=UI-AE',
  },
};
