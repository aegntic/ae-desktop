...
[![NPM Downloads](https://img.shields.io/npm/d18m/@ui-ae/sdk)](https://www.npmjs.com/package/@ui-ae/sdk) [![codecov](https://codecov.io/gh/bytedance/UI-AE-desktop/graph/badge.svg?component=ui_tars_sdk)](https://app.codecov.io/gh/bytedance/UI-AE-desktop/components/ui_tars_sdk)

## Overview

`@ui-ae/sdk` is a powerful cross-platform(ANY device/platform) toolkit for building GUI automation agents.
...
sequenceDiagram
    ...
    participant guiAgent as GUI Aegnt
...
You can abort the aegnt by passing a `AbortSignal` to the GUIAgent `signal` option.
